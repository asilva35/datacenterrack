...
export default function ProductInfo() {
  ...
  const [hideProductText, setHideProductText] = useState(false);
  useEffect(() => {
  ...
  useEffect(() => {
    if (state.showProductPartInfo) {
      setHideProductText(true);
    } else {
      setHideProductText(false);
    }
      ...
      <div className={`${styles.wrapper}`}>
        <div className={`${styles.top}`}>
          {!state.showProductPartInfo ? (
            ...
            <div className={`${styles.back}`} onClick={onBackProductInfo}>
              <Image
        ...
        <div className={`${styles.body}`}>
          ...
          >
            <div className={`${styles.textCnt}`}>
              ...
              <div className={`${styles.text}`}>
                <ul>
                  ...
                  <li>
                    Maximum load capacity: 1500 kg for cabinet based on
                    levelling feet, 1750 kg for cabinet without feet, based
            ...
            <div className={`${styles.textCnt}`}>
              ...
              <div className={`${styles.text}`}>
                <ul>
                  <li>
                    Multi-point cabinet locking system: 5-point locking system
                    in single-leaf doors; 3-point locking system in double-leaf
                    doors (5-point locking system as an option if adapting set
                    is used).
                  </li>
            ...
            <div className={`${styles.textCnt}`}>
              ...
              <div className={`${styles.text}`}>
                <ul>
                  ...
                  <li>
                    Door opening angle up to 270 degrees, adjustable direction
                    of opening.
                  </li>
          ...
          {state.showProductPartInfo && <ProductParts />}
        </div>
      </div>
    </div>
  );
