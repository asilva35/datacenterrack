...
export default function Metaheader({
  title = 'Datacenter Solutions | Datacenter Rack',
  description = 'Datacenter Solutions',
  keywords = 'datacenter solutions',
  og_image = '/assets/images/og/og.jpg',
  yoast_head = false,
  author = 'Datacenterrack',
  link = '',
  domain = 'datacenterrack.com',
  twitter = '@datacenterrack',
  noindex = false,
}) {
    ...
    <>
      <Head>
        ...
        <link
          ...
          sizes="180x180"
          href="/assets/images/favicon/apple-touch-icon.png?v=2625344867"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href="/assets/images/favicon/favicon-32x32.png?v=2625344867"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="/assets/images/favicon/favicon-16x16.png?v=2625344867"
        />
        <link
          rel="manifest"
          href="/assets/images/favicon/site.webmanifest?v=2625344867"
        />
        <link
          rel="mask-icon"
          href="/assets/images/favicon/safari-pinned-tab.svg?v=2625344867"
          color="#5bbad5"
        />
